...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>address :</span>
            <input type="text" name="street" required placeholder="ex. Jln. Jalan aja dulu">
         </div>
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="ex. Jakarta">
         </div>
         
         <div class="inputBox">
            <span>country :</span>
            <input type="text" name="country" required placeholder="ex. Wakanda">
         </div>
         <div class="inputBox">
